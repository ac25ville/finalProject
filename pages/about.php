...
<script
  ...
  crossorigin="anonymous"></script>
    <script src="../script/js_jquery/about.js"></script>
...
<body>
    ...
    <div class="content shadow">
<!--
    Make a form here where they can submit a response and choose what it's about, including ideas for BRC, the office overall, or feedback for the BRC
-->
        <h3>Feedback</h3>
        <form id="feedback_form" action="../script/php/about_feedback.php?funct=printFeedback" method="POST">
            <div class="response_wrap">
                <label for="feedback_name">Name:</label><br><input type="text" id="feedback_name" name="feedback_name">
                
            </div>
            <div class="response_wrap">
                <label for="feedback_sNum">Student#:</label><br><input type="number" id="feedback_sNum" name="feedback_sNum">
            </div>
            <div class="textarea_wrap">
                <textarea placeholder="Type a short response here!" id="feedback_response" name="feedback_response"></textarea>
            </div>
